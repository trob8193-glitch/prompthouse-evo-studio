...
import { BentoBoxLayout, BentoCard } from '../components/layouts/BentoBoxLayout.jsx';
...
function Stat({ label, value, sub, icon: Icon }) {
  return (
    <BentoCard rowSpan={1} className="flex flex-col gap-4 gap-4 justify-center">
      ...
      <div className="mt-2 text-3xl font-black text-neon-cyan drop-shadow-[0_0_10px_rgba(0,240,255,0.3)]">{value}</div>
  ...
  return (
    ...
    >
      ...
      <BentoBoxLayout>
        ...
        <BentoCard rowSpan={1} colSpan={2}>
          <h2 style={{ margin: 0, fontSize: 16, fontWeight: 900 }}>Cache + Reviews</h2>
          <div style={{ marginTop: 12, color: '#94a3b8', fontSize: 13, lineHeight: 1.9, display: 'flex', gap: 20 }}>
