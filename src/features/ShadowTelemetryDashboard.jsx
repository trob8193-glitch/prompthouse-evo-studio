      ...
      return (
        <div className="flex-1 flex flex-col p-6 gap-6 overflow-auto">
          ...
          <div className="flex gap-4">
            <button className="bg-[#ff0000]/20 text-[#ff0000] border border-[#ff0000]/50 px-4 py-2 hover:bg-[#ff0000]/40 transition-colors uppercase tracking-widest text-xs font-bold rounded">
              Approve & Execute
            </button>
            <button className="bg-transparent text-[#ff0000]/50 border border-[#ff0000]/20 px-4 py-2 hover:bg-[#ff0000]/10 transition-colors uppercase tracking-widest text-xs font-bold rounded">
              Dismiss Intent
            </button>
          </div>
        </div>
