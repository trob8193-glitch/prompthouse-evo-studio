...
export default function OmniscientObservabilityDeck() {
  return (
    <IDEPageLayout
      ...
      actions={
        <button className="glass-extreme text-green-400 hover:border-green-400/80 transition-all rounded-xl px-4 py-2 text-xs font-black inline-flex items-center gap-2" onClick={() => { safeFetchBridge('/api/studio/scan').then(d => console.log('[Observability] Scan:', d)).catch(() => {}); }}>
