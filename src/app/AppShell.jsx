...
export default function AppShell({ children }) {
  ...
  return (
    <div className="app-shell flex h-screen w-full bg-[#121212] text-white font-sans overflow-hidden">
      <aside className="w-64 border-r border-[#333] flex flex-col gap-4 gap-4 p-4 space-y-4">
        <h1 className="text-xl font-bold tracking-widest text-[#00ffcc]">EVO STUDIO</h1>
        <nav className="flex flex-col gap-4 gap-4 space-y-2 text-sm text-gray-400">
      ...
      <main className="flex-1 flex flex-col gap-4 gap-4 relative overflow-y-auto">
