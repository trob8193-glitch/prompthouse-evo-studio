  ...
  return (
    <div className="p-8 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <section className="glass-extreme border-cyan-500/30 shadow-[0_0_15px_rgba(0,240,255,0.05)] rounded-2xl p-6">
          <h2 className="text-lg font-bold mb-6 flex items-center gap-2">
            <Users size={20} className="text-slate-400" /> Active Connectors
          </h2>
          <div className="space-y-4">
            <div className="bg-black/30 p-4 rounded-3xl border-cyan-500/30 shadow-[0_0_15px_rgba(0,240,255,0.05)] flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="p-3 bg-blue-500/10 rounded-2xl"><Kanban className="text-neon-cyan" /></div>
                <div>
            ...
            <div className="bg-black/30 p-4 rounded-3xl border-cyan-500/30 shadow-[0_0_15px_rgba(0,240,255,0.05)] flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="p-3 bg-purple-500/10 rounded-2xl"><MessageSquare className="text-purple-400" /></div>
                <div>
        ...
        <section className="glass-extreme border-cyan-500/30 shadow-[0_0_15px_rgba(0,240,255,0.05)] rounded-2xl p-6">
          <h2 className="text-lg font-bold mb-6 flex items-center gap-2">
            <TrendingUp size={20} className="text-neon-cyan" /> Automated KPI Report
          </h2>
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 bg-indigo-500/5 border-indigo-500/20 rounded-3xl">
            ...
            <div className="p-4 bg-emerald-500/5 border-emerald-500/20 rounded-3xl">
            ...
            <div className="p-4 bg-yellow-500/5 border-yellow-500/20 rounded-3xl col-span-2">
      ...
      {/* Permissions Section */}
      <footer className="bg-indigo-900/10 border-indigo-500/20 rounded-2xl p-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
      ...
      {permissionsVisible && (
        <section className="bg-slate-950 border-indigo-500/20 rounded-2xl p-5">
