...
class _StudioShellState extends State<StudioShell> {
  ...
  @override
  Widget build(BuildContext context) {
    final pages = const [StudioHomePage(), ExtensionFoundryScreen(), EvoStudioBuilderScreen()];
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: const [
          ...
          NavigationDestination(icon: Icon(Icons.account_tree_outlined), selectedIcon: Icon(Icons.account_tree), label: 'Evo Builder'),
        ],
      ),
    );
  }
