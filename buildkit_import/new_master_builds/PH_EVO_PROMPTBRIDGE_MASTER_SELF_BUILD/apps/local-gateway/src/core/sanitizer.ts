...
export function sanitizeText(input: string): { text: string; secretsRemoved: boolean } {
  let text = input;
...
export function sanitizePayload(payload: unknown): { payload: unknown; secretsRemoved: boolean } {
