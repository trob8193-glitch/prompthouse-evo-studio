...
export default function CyborneticSplitParagram() {
  return (
    <div className="relative w-full h-full min-h-[500px] bg-black rounded-3xl overflow-hidden flex shadow-[0_0_50px_rgba(255,0,255,0.1)]">
      ...
      {/* Left Angled Panel */}
      <div 
        className="w-1/2 h-full bg-[#1a0033] relative z-10 border-r border-[#ff00ff]/50 backdrop-blur-3xl flex flex-col justify-center p-12"
      ...
      <div className="absolute inset-0 flex justify-end">
        <div 
          className="w-[60%] h-full bg-[#050010] p-12 flex flex-col justify-center items-end text-right border-l border-[#00f0ff]/20"
          style={{ clipPath: 'polygon(20% 0, 100% 0, 100% 100%, 0% 100%)' }}
        >
          <div className="text-[#00f0ff] text-[10px] uppercase font-bold tracking-[0.3em] mb-4">Output Vector</div>
          <div className="space-y-4 w-2/3">
            {[1, 2, 3].map(i => (
              <div key={i} className="bg-[#00f0ff]/5 border border-[#00f0ff]/20 rounded-xl p-4 flex items-center justify-end gap-4 hover:bg-[#00f0ff]/10 transition-colors">
