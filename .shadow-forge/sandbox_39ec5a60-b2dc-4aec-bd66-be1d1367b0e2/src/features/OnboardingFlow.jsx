        ...
        {step === 0 && (
          <div style={s.stepContent}>
            ...
            <p style={s.body}>
              ...
              32 specialized agents. 10 living UI paradigms. An autonomous mutation engine that improves itself overnight.
            </p>
            <div style={s.featureGrid}>
              {[
                ['🤖', '32 AI Agents', 'Specialized bots with distinct roles'],
                ['🌀', 'Self-Evolution', 'Studio improves itself autonomously'],
                ['💎', '10 UI Themes', 'Living interface paradigms'],
        ...
        {step === 4 && (
          <div style={{ ...s.stepContent, textAlign: 'center' }}>
            ...
            <div style={s.launchChecks}>
              {[
                '32 specialized AI agents activated',
