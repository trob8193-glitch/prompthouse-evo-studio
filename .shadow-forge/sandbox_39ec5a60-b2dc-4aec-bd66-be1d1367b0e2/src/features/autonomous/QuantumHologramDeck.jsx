...
export default function QuantumHologramDeck() {
  return (
    <div className="w-full h-full flex-col gap-4 items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 flex-col gap-4 items-center justify-center w-full h-full p-12">
        ...
        <div className="grid grid-cols-3 gap-12 w-full max-w-4xl mt-12">
          {['Spawn Sentinels', 'Run Diagnostics', 'Collapse Waveform'].map((action, i) => (
            <div key={i} className="flex-col items-center gap-6 group cursor-pointer">
