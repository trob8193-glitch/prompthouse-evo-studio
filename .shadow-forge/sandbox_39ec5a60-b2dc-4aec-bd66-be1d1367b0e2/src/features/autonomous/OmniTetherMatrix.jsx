...
export default function OmniTetherMatrix() {
  ...
  return (
    <div className="w-full h-full p-8 bg-black flex-col gap-4 font-mono text-neon-gold border-8 border-yellow-900/30 rounded-3xl overflow-hidden relative shadow-[inset_0_0_100px_rgba(255,184,0,0.1)]">
      ...
      <div className="flex-1 flex-col gap-8 relative z-10">
        <div className="grid grid-cols-4 gap-4">
          <div className="bg-yellow-900/20 border-yellow-500/20 p-4 flex-col gap-4 justify-center items-center">
          ...
          <div className="bg-yellow-900/20 border-yellow-500/20 p-4 flex-col gap-4 justify-center items-center col-span-2">
        ...
        <div className="flex-1 bg-yellow-900/10 border-yellow-500/20 p-6 flex-col gap-4">
