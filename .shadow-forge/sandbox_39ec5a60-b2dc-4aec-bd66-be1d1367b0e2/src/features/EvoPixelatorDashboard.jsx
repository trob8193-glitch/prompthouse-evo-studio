...
export default function EvoPixelatorDashboard() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      let imageUrl = '';
      try {
        parsedManifest = JSON.parse(response);
        imageUrl = parsedManifest.url || '';
      } catch (e) {
        parsedManifest = { raw: response };
      }
    ...
    >
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 relative z-10">
        <div className="xl:col-span-4 space-y-8">
          <Card className="p-8 border-[#00ff88]/20 bg-[#050508]/80 backdrop-blur-xl shadow-[0_0_30px_rgba(0,255,136,0.05)]">
            ...
            <textarea 
              className="w-full bg-[#0a0a10] border-[#00ff88]/30 rounded-3xl p-4 text-white text-sm focus:outline-none focus:border-[#00ff88] focus:ring-1 focus:ring-[#00ff88] transition-all min-h-[120px]! mb-6 font-mono!" 
            ...
            <div className="space-y-6 mb-8">
              ...
              <div>
                ...
                <select 
                  className="w-full bg-[#0a0a10] border-[#00ff88]/30 rounded-2xl p-3 text-white text-sm focus:outline-none focus:border-[#00ff88] transition-all font-mono!" 
            ...
            <Button onClick={handleGenerate} disabled={generating || !prompt} className="w-full bg-linear-to-r! from-[#00ff88]! to-[#00f0ff]! text-black! flex justify-center items-center gap-3 border-none! shadow-[0_0_20px_rgba(0,255,136,0.4)] hover:shadow-[0_0_30px_rgba(0,255,136,0.6)] font-black">
