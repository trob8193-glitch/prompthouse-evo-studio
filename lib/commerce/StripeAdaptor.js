...
export class StripeAdaptor {
  ...
  generateMockResponse(params) {
    return {
      ...
      url: `${this.baseUrl}/mock-checkout`,
      mockLink: `${this.baseUrl}/mock-checkout?p=${params.productName}`,
      receipt: `mock_receipt_${Date.now()}`,
      injectionCode: `<!-- MOCK STRIPE BUTTON -->\n<button onclick="alert('Mock Checkout for ${params.productName}')">Buy Now</button>`
    };
  }
}
