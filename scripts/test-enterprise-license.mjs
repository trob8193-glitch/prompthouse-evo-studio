...
console.assert(managerWithoutPublicKey.isEnterprise() === false, 'Should stay community without PROMPTHOUSE_PUBLIC_KEY');
console.assert(
...
console.assert(managerWithLicense.isEnterprise() === true, 'Should be in enterprise mode with verified license');
