...
async function runBrowserProof() {
  ...
  try {
    ...
    await waitForHttp('http://127.0.0.1:3001/status', 30000);
    ...
    for (const [name, url] of Object.entries({
      studio: 'http://127.0.0.1:3001/api/studio/scan',
      security: 'http://127.0.0.1:3001/api/security/audit',
      providers: 'http://127.0.0.1:3001/api/provider-activation/status'
    })) {
